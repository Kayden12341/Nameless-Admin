...
local PredictionInput = Instance.new("TextLabel")
...
PredictionInput.Parent = CenterBar
PredictionInput.BackgroundTransparency = 1
PredictionInput.Position = UDim2.new(0.5, 0, 0.5, 0)
PredictionInput.Size = UDim2.new(1, -5, 0.7, 0)
PredictionInput.AnchorPoint = Vector2.new(0.5, 0.5)
PredictionInput.ZIndex = 1
PredictionInput.Font = Enum.Font.SourceSans
PredictionInput.Text = ""
PredictionInput.TextColor3 = Color3.fromRGB(100, 100, 100)
PredictionInput.TextScaled = true
PredictionInput.TextWrapped = true
PredictionInput.ClipsDescendants = true
