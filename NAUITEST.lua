function CreateNeonFrame(name, size, position, parent)
...
function CreateTopbar(name, parent)
	...
	Clear.BackgroundTransparency = 0.3
	...
	Minimize.MouseEnter:Connect(function()
		TweenService:Create(Minimize, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 200, 255)}):Play()
	end)
	Minimize.MouseLeave:Connect(function()
		TweenService:Create(Minimize, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 255, 255)}):Play()
	end)

	Exit.MouseEnter:Connect(function()
		TweenService:Create(Exit, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 0, 0)}):Play()
	end)
	Exit.MouseLeave:Connect(function()
		TweenService:Create(Exit, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 255, 255)}):Play()
	end)
...
local CmdBar = CreateNeonFrame("CmdBar", UDim2.new(0.8, 0, 0, 50), UDim2.new(0.5, 0, 0.2, 0), AdminUI)
...
local Autofill = CreateNeonFrame("Autofill", UDim2.new(0.8, 0, 0, 120), UDim2.new(0.5, 0, 0.2, 0), AdminUI)
...
local Commands = CreateNeonFrame("Commands", UDim2.new(0, 280, 0, 320), UDim2.new(0.1, 0, 0.5, 0), AdminUI)
...
local UpdLog = CreateNeonFrame("UpdLog", UDim2.new(0, 280, 0, 320), UDim2.new(0.9, -140, 0.2, 0), AdminUI)
...
local ChatLogs = CreateNeonFrame("ChatLogs", UDim2.new(0, 400, 0, 300), UDim2.new(0.5, 0, 0.7, 0), AdminUI)
...
local soRealConsole = CreateNeonFrame("soRealConsole", UDim2.new(0, 400, 0, 300), UDim2.new(0.1, 0, 0.7, 0), AdminUI)
...
local UICorner22 = Instance.new("UICorner", CmdBar)
local NeonUnderline = Instance.new("Frame", CmdBar)
local ListLayout222 = Instance.new("UIListLayout")
local ListLayout23 = Instance.new("UIListLayout")
local ListLayout33 = Instance.new("UIListLayout")
local ListLayout44 = Instance.new("UIListLayout")
...
CmdBar.BackgroundTransparency = 0.4
...
NeonUnderline.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
NeonUnderline.Size = UDim2.new(1, 0, 0, 2)
NeonUnderline.Position = UDim2.new(0, 0, 1, -2)
...
CreateTopbar("Commands", Commands)
...
ListLayout222.Parent = Container
ListLayout222.Padding = UDim.new(0, 5)
...
CreateTopbar("Update Log", UpdLog)
...
ListLayout23.Parent = Container_2
ListLayout23.Padding = UDim.new(0, 5)
...
CreateTopbar("Chat Logs", ChatLogs)
...
ListLayout33.Parent = Container_3
ListLayout33.Padding = UDim.new(0, 5)
...
CreateTopbar("Console", soRealConsole)
...
ListLayout44.Parent = Container_4
ListLayout44.Padding = UDim.new(0, 5)
